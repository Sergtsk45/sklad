...
_ACTIONS_RULES_BLOCK = (
    ...
    "   ПОИСК ПОСТАВЩИКА: если пользователь просит найти поставщика из счёта,\n"
    ...
    "     - Предложи только create_partner_draft с name/vat/street/comment "
    "из partner.partner_draft_args.\n"
